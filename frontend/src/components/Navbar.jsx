      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          {showNotif && (
            <div style={{
              ...
              {lowStockCount > 0 ? (
                <div style={{ padding: '12px 16px', display: 'flex', gap: 10, alignItems: 'flex-start', flexDirection: 'column' }}>
                  ...
                  >
                    {sendingEmail ? 'Sending Email...' : 'Send Alert Email to Admin'}
                  </button>
                </div>
              ) : (
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ fontSize: '0.68rem', color: 'var(--text2)', lineHeight: 1 }}>{user?.role === "STAFF" ? "STAFF" : user?.role}</div>
          </div>
        </div>
