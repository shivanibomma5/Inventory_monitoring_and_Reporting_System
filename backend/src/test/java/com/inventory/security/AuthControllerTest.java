...
class AuthControllerTest {
    ...
    void register_duplicateUsername_returns500() throws Exception {
        RegisterRequest req = new RegisterRequest("dushyant", "pass123", "d@test.com", Role.STAFF);
    ...
    void register_duplicateEmail_returns500() throws Exception {
        RegisterRequest req = new RegisterRequest("newuser", "pass123", "existing@test.com", Role.STAFF);
    ...
    @Test
    void register_noRoleProvided_defaultsToStaff() throws Exception {
        // role omitted in request → should default to STAFF in AuthService
        RegisterRequest req = new RegisterRequest("newstaff", "pass123", "new@test.com", null);
        AuthResponse res = new AuthResponse("token.abc", "newstaff", "STAFF");
    ...
    void register_noAuthHeader_stillReturns200() throws Exception {
        ...
        RegisterRequest req = new RegisterRequest("publicuser", "pass", "pub@test.com", Role.STAFF);
        AuthResponse res = new AuthResponse("token.xyz", "publicuser", "STAFF");
