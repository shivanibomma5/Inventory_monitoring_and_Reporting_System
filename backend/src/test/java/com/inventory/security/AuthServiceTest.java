...
class AuthServiceTest {
    ...
    void register_duplicateUsername_throwsRuntimeException() {
        RegisterRequest req = new RegisterRequest("dushyant", "pass", "new@test.com", Role.STAFF);
    ...
    void register_duplicateEmail_throwsRuntimeException() {
        RegisterRequest req = new RegisterRequest("newuser", "pass", "dushyant@test.com", Role.STAFF);
    ...
    @Test
    void register_nullRole_defaultsToStaff() {
        ...
        when(userRepository.save(any(User.class))).thenAnswer(inv -> {
            ...
            assertEquals(Role.STAFF, u.getRole()); // verify default applied
            return u;
        });
    ...
    void register_passwordIsEncodedBeforeSave() {
        RegisterRequest req = new RegisterRequest("user", "plaintext", "u@test.com", Role.STAFF);
